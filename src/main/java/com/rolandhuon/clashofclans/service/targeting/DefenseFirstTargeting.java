...
@Component
public class DefenseFirstTargeting implements TargetingStrategy {
    ...
    public Optional<Damageable> chooseTarget(List<Damageable> targets) {
        ...
        return alive.stream()
                .filter(t -> t instanceof Building building && building.getType().isDefensive())
                .findFirst()
    ...
    public TargetingMode mode() {
        return TargetingMode.DEFENSE_FIRST;
    }
}
